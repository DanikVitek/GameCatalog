...
import exception.{ IllegalContentTypeException, InvalidDtoException, UserAlreadyRegisteredException }
    ...
    override def execute(req: HttpServletRequest, resp: HttpServletResponse): Unit =
        ...
        Try(json.as[RegDto]) match
            ...
            case Success(regDto) =>
                ...
                userDao.save(User
                  .builder
                  .withFirstname(regDto.firstName)
                  .withLastname(regDto.lastName)
